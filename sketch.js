...
function preload()
{
 playerA=loadImage("kid.png")
 buildA=loadImage("building.png")
 cityA=loadImage("city1.png")
logA=loadImage("log1.png");
grassA=loadImage("grass.jpg")
carA=loadImage("car1.png")
gw=loadImage("partyover.jpg")
}
